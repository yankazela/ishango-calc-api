...
import { CapitalGainServiceImpl } from './service/capital-gain/CapitalGainServiceImpl';
...
@Module({
	...
	providers: [
		...
		{
			provide: CalculatorSymbols.CapitalGainService,
			useClass: CapitalGainServiceImpl,
		},
	],
})
